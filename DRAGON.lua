...
if res ~= 200 then
print('\27[0;31m⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
echo "⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺ ⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺ ┉"
exit 1
fi
if [ ! $token ]; then
echo "⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺ ⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺ ┉ ┉"
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/hmedsiria/si/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1726705278,1321115355,1465250253,1726705278}   
...
elseif tonumber(user_id) == tonumber(1465250253) then  
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1321115355) then  
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'مالك البوت '  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'ايدك'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "idek9")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²²")  
...
os.execute('wget https://raw.githubusercontent.com/ahmedsiria/si/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' 🎀 تم تحديث السورس \n 🎀 لديك اخر اصدار لسورس ايدك \n 🎀 الاصدار 🎀 { v 7.0}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 🎀 اصدار سورس ايدك\n 🎀 الاصدار 🎀{ v 7.0}')
end
if text == 'المبرمج سوريا' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𝑫𝑬𝑽 𝑺𝑰𝑹𝑰𝑨 𖡚℡](t.me/SIRIA199)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '🎀 S I R I A🎀', url="t.me/SIRIA199"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/idek9"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n 🎀 العضو 🎀 ['..result.title_..'](t.me/'..(username or 'idek9')..')'
status  = '\n 🎀 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🎀 العضو 🎀 ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'idek9')..') \n 🎀 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," 🎀 العضو : {["..data.first_name_.."](T.ME/idek9)}\n 🎀 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🎀 عذرا 🎀 {["..data.first_name_.."](T.ME/idek9)}\n 🎀 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
🎀  𝑾𝑬𝑳𝑪𝑶𝑴 𝑻𝑶 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²²  🎀
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𝗗𝗘𝗩 𝗦𝗜𝗥𝗜𝗔 𓏢 𖡚℡  ',url="t.me/SIRIA199"}},
{{text = ' 🎀 ＤＥＶ ＯＲＡＢＩ᪥🎀 ',url="t.me/DEV_ORABI"}},
{{text = '🎀 𝗗𝗘𝗩 𝗙𝗥3𝗢𝗡 ?? 🎀',url="t.me/Fr3on1"}},
{{text = '🎀 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² 🎀', url="t.me/idek9"}},
{{text = '🎀 𝚃𝙾 𝙰𝚂𝙺 🎀',url="t.me/SIRIA199"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'سوريا' or text == 'Alex' or text == 'ALEX' then
local Text = [[
اقمـد مـن القـمدان يـبرو
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🎀  S I R I A 🎀',url="t.me/SIRIA199"}},
...
if text == 'ايدك' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 🎀 بواسطه 🎀 ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'idek9')..') \n 🎀 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🎀 بواسطه 🎀 ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'idek9')..') \n 🎀 تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🎀 بواسطه ??‍♂️ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'idek9')..') \n 🎀 تـم قفـل المتحركه بالطرد ')
end,nil)   
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/hmedsiria/si/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 🎀 اهلا بك في متجر ملفات ايدك\n 🎀 ملفات السورس ↓\n⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺\n\n"
local TextE = "\n⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺\n 🎀 علامة تعني { ✔️ } ملف مفعل\n 🎀 علامة تعني { ✖ } ملف معطل\n 🎀 قناة سورس ايدك↓\n".." 🎀 [اضغط هنا لدخول](t.me/idek9) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/hmedsiria/si/main/File_Bot/"..file)
if res == 200 then
...
if text == ("مسح قائمه ايدك") and Sudo(msg) then
...
if text == ("رفع ايدك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ايدك @(.*)$") and Sudo(msg) then
local username = text:match("^رفع ايدك @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ايدك (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ايدك (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل ايدك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ايدك @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ايدك @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ايدك (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ايدك (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🎀 لعضو 🎀 ['..data.first_name_..'](t.me/'..(data.username_ or 'idek9')..')'
status  = '\n 🎀 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🎀 العضو 🎀 '..userid..''
...
' }\n'..' 🎀  الايدي بالصوره 🎀 { '..idph..
' }\n'..' 🎀  الرفع 🎀 { '..setadd..
' }\n'..' 🎀  الحظر 🎀 { '..banm..' }\n\n⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺\n 🎀 قناة سورس ايدك ↓\n [ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²²](t.me/idek9) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🎀 العضو 🎀 ['..result.title_..'](t.me/'..(text1[3] or 'idek9')..')'..'\n 🎀 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ايدك').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ايدك')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐍𝐆𝐄??𝐒.',url="t.me/idek9"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."idek9:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."idek9:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."idek9:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."idek9:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"🎀تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."idek9:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."idek9:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس ايدك يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ايدك').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/idek9)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/idek9)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/idek9)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/idek9)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/idek9)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/idek9)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/idek9)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/idek9)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/idek9)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/idek9)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/idek9)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/idek9)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/idek9)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/idek9)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/idek9)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/idek9)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/idek9)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يولا يا وسخ 🥵](t.me/idek9)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[الحمد لله يقلبي ❤️](t.me/idek9)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[اوماااااال يا جدع 😹❤️](t.me/idek9)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[تيب تيب يعسل 😁](t.me/idek9)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بلاش نكد بحبك 😁 ](t.me/idek9)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يستر عايز اي 🤭](t.me/idek9)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/idek9)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/idek9)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/idek9)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/idek9)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/idek9)') 
return false
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'idek9')..')'
local iduser = result.sender_user_id_
...
{
{text = '⚡️ قفل و القفل ⚡️', callback_data="/help1"},{text = '⚡️ تعطيل و تفعيل ⚡️', callback_data="/help2"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = ' 𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²²', url="t.me/idek9"},
...
⚡️ الاشعارات
⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺
[⚡️ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ⚡️ ](t.me/idek9)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '⌯ ⚡️ قفل و القفل ⚡️ ⌯', callback_data="/help"},{text = '⚡️ تعطيل و تفعيل ⚡️', callback_data="/help2"},
},
}
...
{
{text = '⚡️ قفل و القفل ⚡️', callback_data="/help1"},{text = '⌯ ⚡️ تعطيل و تفعيل ⚡️ ⌯', callback_data="/help"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Teext =[[
اتبع الازرار تحت 
واستمتع للأوامر سورس ايدك 🕹️
[🎀 𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² 🎀](t.me/idek9)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🎀 اوامر الوضع 🎀', callback_data="/help3"},{text = ' 🎀 التنزيل والرفع 🎀', callback_data="/help4"},
},
{
{text = '🎀 اوامر المطورين 🎀', callback_data="/help5"},{text = '🎭 اوامر الأعضاء 🎭', callback_data="/help6"},
},
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ايدك')
