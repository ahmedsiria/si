...
if res ~= 200 then
print('\27[0;31mٴ≪⊱━━━━⊱━━━━⊰✾𝘚𝘖𝘜𝘙𝘊𝘌 𝘚𝘐𝘙𝘐𝘈❃⊱━━━━⊰━━━━⊰≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪⊱━━━━⊱━━━━⊰✾𝘚𝘖𝘜𝘙𝘊𝘌 𝘚𝘐𝘙𝘐𝘈❃⊱━━━━⊰━━━━⊰≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪⊱━━━━⊱━━━━⊰✾𝘚𝘖𝘜𝘙𝘊𝘌 𝘚𝘐𝘙𝘐𝘈❃⊱━━━━⊰━━━━⊰≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "ٴ≪⊱━━━━⊱━━━━⊰✾𝘚𝘖𝘜𝘙𝘊𝘌 𝘚𝘐𝘙𝘐𝘈❃⊱━━━━⊰━━━━⊰≫ٴ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "ٴ≪⊱━━━━⊱━━━━⊰✾𝘚𝘖𝘜𝘙𝘊𝘌 𝘚𝘐𝘙𝘐𝘈❃⊱━━━━⊰━━━━⊰≫ٴ ٴ≪⊱━━━━⊱━━━━⊰✾𝘚𝘖𝘜𝘙𝘊𝘌 𝘚𝘐𝘙𝘐𝘈❃⊱━━━━⊰━━━━⊰≫ٴ ┉"
exit 1
fi
if [ ! $token ]; then
echo "ٴ≪⊱━━━━⊱━━━━⊰✾𝘚𝘖𝘜𝘙𝘊𝘌 𝘚𝘐𝘙𝘐𝘈❃⊱━━━━⊰━━━━⊰≫ٴ ٴ≪⊱━━━━⊱━━━━⊰✾𝘚𝘖𝘜𝘙𝘊𝘌 𝘚𝘐𝘙𝘐𝘈❃⊱━━━━⊰━━━━⊰≫ٴ ┉ ┉"
...
sudo_users = {SUDO,1726705278,1465250253}   
...
local hash = database:sismember(bot_id.."SIRIA199:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevSoFi(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
var = true  
elseif database:sismember(bot_id..'SIRIA199:MN:TF'..chat_id, user_id) then
var = true 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇✾𝘚𝘖𝘜𝘙𝘊𝘌 𝘚𝘐𝘙𝘐𝘈❃.")  
...
bnnaGet(msg.sender_user_id_, SIRIA199_name)
end
...
{{text = '❃ 𝗗𝗘𝗩 𝗙𝗥3𝗢𝗡 𖡛 ❃',url="t.me/Fr3on1"}},
{{text = '❃ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ❃', url="t.me/SIRIA199"}},
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."SIRIA199:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'SIRIA199:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
database:del(bot_id..'SIRIA199:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ℘︙ تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'SIRIA199:MN:TF'..msg.chat_id_)
t = "\n ℘︙ قائمة المنظفين \n≪━━━━━━𝓓𝓡𝓖━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'SIRIA199:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_SYRIA')..')'
status  = '\n ℘︙ تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'SIRIA199:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'SOURCE_SYRIA')..')'
status  = '\n ℘︙ تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'SIRIA199:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_SYRIA')..')'
status  = '\n ℘︙ تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'SIRIA199:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_SYRIA')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'SIRIA199:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'SOURCE_SYRIA')..')'
status  = '\n ℘︙ تم تنزيله من المنظفين'
texts = usertext..status
else
...
database:srem(bot_id..'SIRIA199:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_SYRIA')..')'
status  = '\n ℘︙ تم تنزيله من المنظفين'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_SYRIA')..')'
...
' }\n'..' ℘︙  الايدي بالصوره » { '..idph..
' }\n'..' ℘︙  الرفع » { '..setadd..
' }\n'..' ℘︙  الحظر » { '..banm..' }\n\nٴ≪⊱━━━━⊱━━━━⊰✾𝘚𝘖𝘜𝘙𝘊𝘌 𝘚𝘐𝘙𝘐𝘈❃⊱━━━━⊰━━━━⊰≫ٴ\n ℘︙ قناة سورس سوريا ↓\n [✾┇✾𝘚𝘖𝘜𝘙𝘊𝘌 𝘚𝘐𝘙𝘐𝘈❃.](t.me/SOURCE_SYRIA) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if not database:get(bot_id..'SIRIA199:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'SIRIA199:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."SIRIA199:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."SIRIA199:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "℘︙ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."SIRIA199:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."SIRIA199:allM"..msg.chat_id_)
...
if database:sismember(bot_id..'SIRIA199:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'SIRIA199:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
end --الكود حصري سورس سوريا يعني لو بكتهن راح اعرفك انت الاخذتهن
...
if Num == 0 then 
Text = ' ℘︙ انت مضفتش حد يسطا 🥺'
else
Text = ' ℘︙ جهاتك يسطـا  *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تنظيف المشتركين" and DevSoFi(msg) then 
...
{
{text = '𝑺𝑰𝑹𝑰𝑨 𝑪𝑯𝑨𝑵𝑵𝑬𝑳', url="t.me/SOURCE_SYRIA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'ٴ≪⊱━━━━⊱━━━━⊰✾𝘚𝘖𝘜𝘙𝘊𝘌 𝘚𝘐𝘙𝘐𝘈❃⊱━━━━⊰━━━━⊰≫ٴٴ\n℘︙ ➢ .[✾┇✾𝘚𝘖𝘜𝘙𝘊𝘌 𝘚𝘐𝘙𝘐𝘈❃. ](t.me/SOURCE_SYRIA)➤ ')
end
...
{
{text = '𝑺??𝑹𝑰𝑨 𝑪𝑯𝑨𝑵𝑵𝑬𝑳', url="t.me/SOURCE_SYRIA"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
{
{text = '𝑺𝑰𝑹𝑰𝑨 𝑪𝑯𝑨𝑵𝑵𝑬??', url="t.me/SOURCE_SYRIA"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Fun = {'لوكي وزاحف من ساع زحفلي وحظرته 😒','خوش ولد و ورده مال الله 💋🙄','يلعب ع البنات 🙄', 'ولد زايعته الكاع 😶🙊','صاك يخبل ومعضل ','محلو وشواربه جنها مكناسه 😂🤷🏼‍♀️','اموت عليه 🌝','هوه غير ا��حب مال اني 🤓❤️','مو خوش ولد صراحه ☹️','ادبسز وميحترم البنات  ', 'فد واحد قذر 🙄😒','ماطيقه كل ما اكمشه ريحته جنها بخاخ بف باف مال حشرات 😂🤷‍♀️','مو خوش ولد 🤓' } 
...
if text == 'العاب سوريا' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
اهلا في قائمه الالعاب المتطوره سورس العاب سوريا 
